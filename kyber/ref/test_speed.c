...
int main()
{
  ...
  PRINT_TIMER_HEADER
  TIME_OPERATION_SECONDS(crypto_kem_keypair(pk, sk), "keygen", 3)
	TIME_OPERATION_SECONDS(crypto_kem_enc(ct, key, pk), "encaps", 3)
	TIME_OPERATION_SECONDS(crypto_kem_dec(key, ct, sk), "decaps", 3)
  PRINT_TIMER_FOOTER
  // start_kp = clock();
